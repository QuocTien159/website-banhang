...
Route::middleware('auth:sanctum')->group(function () {
    ...
    */
    Route::middleware('role:'.UserRole::STAFF.','.UserRole::ADMIN)->prefix('admin')->group(function () {
        ...
        Route::get('inventory/adjustments', [AdminInventoryController::class, 'adjustments']);
        ...
        Route::middleware('role:'.UserRole::ADMIN)->group(function () {
            ...
            Route::put('inventory/adjustments/{id}/approve', [AdminInventoryController::class, 'approveAdjustment']);
            Route::put('inventory/adjustments/{id}/reject', [AdminInventoryController::class, 'rejectAdjustment']);
